...
DERIVED_LATEX_PATTERNS = [
    ...
    (r"^teq_apastron$", r"T_{\mathrm{eq, ap}, planet_index}"),
    (r"^teq_periastron$", r"T_{\mathrm{eq, peri}, planet_index}"),
    (r"^teq_flux_averaged$", r"T_{\mathrm{eq}, \langle F \rangle, planet_index}"),
